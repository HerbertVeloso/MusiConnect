...
<?php
	...
	$data_all = mysqli_query($conexao,"SELECT * FROM MUSICA WHERE NOME LIKE '%$pesquisa%' OR ANO LIKE '%$pesquisa%' OR GENERO LIKE '%$pesquisa%' OR ARTISTA LIKE '%$pesquisa%' ORDER BY ID ASC LIMIT $inicio, $quantidade;") or die(mysqli_error($conexao));
