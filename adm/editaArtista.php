...
$sql = mysqli_query($conexao,"SELECT * FROM artista WHERE id = '".$_GET['id']."';");
...
<div class="page-header panel panel-default col-md-10 col-xs-12 text-center">
	...
	<h2 class="center cadTit">Editar Perfil Artistico - <?php echo $row['nome']; ?> <img src="../<?php echo $row['foto']; ?>" class='mini'></h2>
		...
		<div id="actions" class="row">
			...
			<div class="col-md-12 text-right">
				...
				<a href="../adm/artistasAdm.php" class="btn btn-default">Cancelar</a>
